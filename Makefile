...
CPPFLAGS ?= $(INC_FLAGS) -MMD -MP `pkg-config --cflags gtk+-3.0` -lm -g -fsanitize=address -static-libasan
LDLIBS= `pkg-config --libs gtk+-3.0` -MMD -g -lm -fsanitize=address -static-libasan
